...
$medicos = $db->query("SELECT * FROM medicos ORDER BY id ASC")->fetchAll(PDO::FETCH_ASSOC);
$medico_id = $_GET['medico_id'] ?? ($medicos[0]['id'] ?? 0);
...
if ($medico_id) {
    foreach($medicos as $m) if($m['id'] == $medico_id) $medico_atual = $m;
    ...
    <?php if($medico_atual): ?>
        ...
        <div style="padding-bottom: 40px;">
            ...
            <?php foreach($horarios as $h): ?>
                <div class="slot">
                    <strong style="font-size:1.2rem; color:#444"><?= $h['hora_agenda'] ?></strong>
